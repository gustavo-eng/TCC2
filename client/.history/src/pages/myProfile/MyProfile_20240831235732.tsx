...
function MyProfile() {
  ...
  return (
    <div className="flex flex-col  items-center gap-4   lg:w-full w-screen ">
      ...
      <div className="w-full flex flex-col items-center gap-2 ">
        <h1 className="w-full text-green-500 text-center font-semibold text-xl">Pessoais</h1>
        ...
        <Input label="Nascimento" type="date" isOptional className="w-full lg:w-1/2 cursor-pointer"/>
        <Button
          className="w-1/2 text-white text-center font-semibold text-xl bg-green-500 hover:bg-green-500/90 rounded-md"
          label="Editar"
        />
