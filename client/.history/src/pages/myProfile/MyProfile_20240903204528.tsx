    ...
    <div className="flex flex-col  items-center gap-4 pl-4  lg:w-full w-screen ">
      <div className="flex flex-col justify-center gap-3 items-center text-center w-full ">
        ...
        <div className=" w-fit grid grid-cols-2 gap-1 text-sm mx-auto ">
          ...
          <p className="text-gray-500">{isGym ? 'CNPJ': 'CPF'}: 077.703.989 </p>
          <p className="text-gray-500">Numero: 23 </p>
          { isAthlet && <p className="text-gray-500">RG: 077.703.989</p>}
          ...
          {isAthlet &&  <p className="text-gray-500">Nascimento: 26/09/2000</p>}
        </div>
      </div>
      <div className="w-full flex flex-col items-center gap-2 ">
        <h1 className="w-1/2 text-green-500 text-center font-semibold text-xl">Pessoais</h1>
        <Input label={isGym ? 'CNPJ': 'CPF'} isOptional className="w-full lg:w-1/2"/>
        { isAthlet &&  <Input label="RG" isOptional className="w-full lg:w-1/2"/>}
