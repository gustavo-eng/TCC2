...
export const updateGymSchema = z.object({
    ...
    phone: z.string({message: "Deve ser uma string"}).min(8, {message: "Mínimo 8 caracteres"}).max(30, {message: "Máximo 16 caracteres"}).optional(),
    street: z.string({message: "Deve ser uma string"}).min(5, {message: "Mínimo 5 caracteres"}).max(30, {message: "Máximo 16 caracteres"}).optional(),
