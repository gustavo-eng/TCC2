...
export default function CreateAccountManager() {
  ...
  const onSubmit:SubmitHandler<registerAthlet> = async (data: any) => {
    ...
    const options = {
    method: 'POST',
    url: 'http://localhost:3001/athlet',
    ...
    data: {
        ...
        phone: null,
        name: 'lutador3',
        email: 'gustavodias10.2000@alunos.utfpr.edu.brdd',
        role: 'athlet',
        password: 'gustavodias10d',
        neighborhood: 'Conjunto Uniao',
        street: 'Dario Ribeiro de Carvalho',
        number: 243,
        city: 'fasf',
        createdAt: '2024-06-22T00:58:45.000Z',
        updatedAt: '2024-06-22T00:58:45.000Z',
        idGym: 1
      }
    };
    */
