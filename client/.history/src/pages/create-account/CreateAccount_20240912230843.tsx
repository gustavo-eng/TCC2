...
const registerUserSchema = z.object({
    cpf: z.any({message: "Deve ser do tipo string"}),
    rg: z.any({message: "Deve ser do tipo string"}),
    birth: z.any({message: "Deve ser do tipo string"}),
    phone: z.any({message: "Deve ser do tipo string"}),
    name: z.any({message: "Deve ser do tipo string"}),
    ...
    neighborhood: z.any({message: "Deve ser do tipo string"}),
    street: z.any({message: "Deve ser do tipo string"}),
    number: z.any({message: "Deve ser do tipo string"}),
    city: z.any(),
    idGym: z.any(),
});
...
export default function CreateAccountManager() {
  ...
  const onSubmit:SubmitHandler<registerAthlet> = async (data: any) => {
    ...
    try {
        ...
        toast.error(err || 'Erro ao enviar solicitação');
    }
