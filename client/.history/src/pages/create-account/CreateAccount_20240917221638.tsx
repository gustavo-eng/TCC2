...
console.log(v)
  */
const [selectedEventType, setSelectedEventType] = useState<string>(""); // Estado para o valor selecionado no Select
            ...
            <div className="h-[42vh]">
              ...
              */}
              <Select
                ...
                options={gyms}
                selected={selectedEventType} // Valor atual selecionado
                setSelect={setSelectedEventType} // Função para alterar o valor selecionado
