...
export default function CreateAccountManager() {
  ...
  const onSubmit = (data: any) => {
    console.log("Dados do formulário1111:", data);
  };
  const onSubmit2 = (data: any) => {
    console.log("Dados do formulário2222:", data);
  };
    ...
    <div className="w-full h-[70vh] pb-1 mb-0 flex flex-col">
      <form onSubmit={onSubmit}>
        <FormWizard
          ...
          layout="horizontal"
          onComplete={() => onSubmit2} // Finaliza o cadastro
          ...
          <FormWizard.TabContent title="Cadastro" icon="ti-check">
            <div className="h-[42vh]">
              ...
              <Input
                ...
                {...register("academia")}
               // errorMessage={errors.academia?.message}
              />
            </div>
          </FormWizard.TabContent>
        </FormWizard>
