...
export default function LayoutMain({ componentName = 'tab' }) {
        ...
        () => [
            {
                id: 'map',
                title: 'map',
                component: <>comp1dsds vrrr</>,
            },
            {
                id: 'events',
                icon: <Warning size={22} />,
                title: 'event.plural',
                component: <div>Teste2 HAHAH</div>,
            },
            {
                id: 'list',
                title: 'list',
                component: <div>Teste3 HAHAH</div>,
            }
        ],
        [],
    );
    ...
    return (
        <div className="relative">
            ...
            <main>
                <section className='bg-red-400 flex flex-col justify-center'>
                    <div className="flex flex-row justify-center w-[50%] h-full  bg-green-600">
