            ...
            <header className='bg-yellow-300'>
                <nav className=" border-gray-100 px-4 lg:px-6 py-2.5 dark:bg-gray-800 ">
                    <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                        ...
                        <div className={`${isMenuOpen ? 'block' : 'hidden'} mt-4 justify-between items-center w-full lg:flex lg:w-auto lg:order-1`} id="mobile-menu-2">
                            <ul className="flex flex-col bg-purple-300 font-medium lg:flex-row lg:space-x-8 ">
                                <Tabs tabs={tabs} />
                            </ul>
                        </div>
                    </div>
