import { Bird, Building, CalendarPlus, CarProfile, CurrencyCircleDollar, Student } from '@phosphor-icons/react';
...
export default function LayoutMain({ componentName = 'tab' }) {
    ...
    return (
        <div className="relative h-screen bg-gray-300">
            ...
            <main className='  h-[94%] m-0 p-0 flex flex-col '>
                <div className='h-full mb-2'>

                    <section className='p-0 m-0 h-full w-full flex flex-col items-center '>
                        <div className=" lg:w-[75%] h-full w-full mt-0 lg:mt-3  bg-slate-50  flex justify-center items-start rounded-lg border-2 border-green-500">
