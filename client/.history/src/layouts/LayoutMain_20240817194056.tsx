...
export default function LayoutMain({ componentName = 'tab' }) {
    ...
    return (
        <div className="relative h-screen bg-gray-200">
            ...
            <main className=' bg-purple-400 h-[91.2%] bg-[url("https://cdn6.campograndenews.com.br/uploads/noticias/2022/10/19/dd6af8b54f66316947c46611fbfa04dd7adbec0e.jpg")] bg-no-repeat'>
                <div>
