        ...
        <div className="relative h-screen bg-gray-200">
            ...
            <main className='  '>
                <div>
                    ...
                    */}
                    <section className=' pb-14 w-full flex flex-col items-center  bg-[url("https://cdn6.campograndenews.com.br/uploads/noticias/2022/10/19/dd6af8b54f66316947c46611fbfa04dd7adbec0e.jpg")] bg-no-repeat'>
