    ...
    const tabs = useMemo(
        () => [
            ...
            },
            {
                ...
                title: 'Tab Payment',
                component: <>Teste2 HAHAH</>,
            },
            {
                id: 'list',
                title: 'list',
                component: <>Teste3 HAHAH</>,
            }
        ],
        [],
    );
    ...
    return (
        <div className="relative ">
            <header className='bg-yellow-300'>
                <nav className=" border-gray-100 px-4 lg:px-6 py-2.5 dark:bg-gray-800 ">
                    <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                        ...
                        <div className={`${isMenuOpen ? 'block' : 'hidden'} bg-purple-400 justify-between items-center w-full lg:flex lg:w-auto lg:order-1`} id="mobile-menu-2">
                            <ul className="flex flex-col  font-medium lg:flex-row lg:space-x-8 h-full ">
                                <Tabs tabs={tabs} />
                            </ul>
                        </div>
                    </div>
            ...
            <main>
                <section className=' h-full w-full flex flex-col items-center'>
                    <div className=" lg:w-[70%] h-fit w-fit  mt-1 bg-gray-100 rounded-md ">
