...
export default function LayoutMain({ componentName = 'tab' }) {
    ...
    return (
        <div className="relative ">
            <header className=''>
                <nav className="  px-4 lg:px-6 pt-1 pb-0 lg:pb-0 bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90%">
                ...
                <div className='w-full h-[2px] m-0 bg-green-700'>fasd</div>
            </header>
            <main>
                <section className=' h-full w-full flex flex-col items-center'>
                    <div className=" lg:w-[75%] h-fit w-fit  mt-1 bg-gray-50 rounded-md ">
