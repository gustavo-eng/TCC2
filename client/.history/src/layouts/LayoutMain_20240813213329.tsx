import { Bird, CalendarPlus, CurrencyCircleDollar, HandPalm, Student } from '@phosphor-icons/react';
import { useMemo, useState } from 'react';
import BellNotifications from '../components/bell-notifications/BellNotifications';
import ModalRegistrationEvent from '../components/modal/modalRegistrationEvent/ModalRegistrationEvent';
...
export default function LayoutMain({ componentName = 'tab' }) {
    ...
    const tabs = useMemo(
        () => [
            ...
            {
                id: 'list',
                icon: <HandPalm size={25} />,
                component: <TabSeminars />,
            },
            {
                id: 'allStudents',
                icon: <Student size={25} />,
                component: <div>Aqui vai os fdsaf</div>,
            },
            {
                id: 'allStfasdudedsnts',
                icon: <Bird />,
                component: <ModalRegistrationEvent />,
            }
        ],
        [],
    );
