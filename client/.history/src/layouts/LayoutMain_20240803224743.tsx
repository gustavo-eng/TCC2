...
export default function LayoutMain({ componentName = 'tab' }) {
    ...
    return (
        <div className="relative">
            ...
            <main>
                <section className='bg-gray-400 h-full w-full flex flex-col items-center'>
                    <div className="flex flex-col items-center w-[70%] h-full mt-1 bg-gray-100 rounded-lg ">
