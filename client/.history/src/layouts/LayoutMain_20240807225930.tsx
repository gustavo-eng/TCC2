...
export default function LayoutMain({ componentName = 'tab' }) {
    ...
    return (
        <div className="relative ">
            <header className=''>
                <nav className="  px-4 lg:px-6 pt-1 pb-0 lg:pb-0 bg-gradient-to-r bg-gradient-to-r from-slate-900 to-slate-700">
                ...
                <div className='w-full h-[4px] m-0 bg-green-200'>fasd</div>
            </header>
            <main>
