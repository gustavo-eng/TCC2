import { CalendarPlus, CurrencyCircleDollar, HandPalm } from '@phosphor-icons/react';
...
export default function LayoutMain({ componentName = 'tab' }) {
    ...
    const tabs = useMemo(
        () => [
            ...
            {
                id: 'events',
                icon: <CurrencyCircleDollar size={25} weight="duotone" />,
                component: <TabPayments />,
            },
            {
                id: 'list',
                icon: <HandPalm size={25} weight="duotone" />,
    ...
    return (
        <div className="relative ">
            <header className=''>
                <nav className="  px-4 lg:px-6 pt-1 pb-0 lg:pb-0  bg-gradient-to-b from-slate-900 to-slate-800">
                ...
                <div className='w-full h-[4px]  bg-green-500'></div>
            </header>
            <main>
                <section className=' h-full w-full flex flex-col items-center'>
                    <div className=" lg:w-[75%] h-full w-full  mt-3 bg-gray-100  flex justify-center items-start rounded ">
