import { Bird, Building, CalendarPlus, CurrencyCircleDollar, Student, User } from '@phosphor-icons/react';
...
export default function LayoutMain({ componentName = 'tab' }) {
    ...
    const tabs = useMemo(() => {
        if (user.role === 'athlet') {
            return [
                ...
                { id: 'myProfile', icon: <User size={20} />, component: <TabTestModal /> },
            ];
        } else if (user.role === 'gym') {
            return [
                { id: 'tabCompetition', icon: <CalendarPlus size={25} /> },
                { id: 'listAthlets', icon: <Student size={25} /> },
                { id: 'registersAthlets', icon: <FlashlightIcon />, text: 'Incricoes atletas' },
            ...
            return [
                ...
                { id: 'allStfasdudedsnts', icon: <Bird />, component: <TabTestModal /> },
            ];
        }
    }, [user]);
    ...
    return (
        <div className="flex flex-col min-h-screen bg-gray-200/100">
            ...
            <main className=' h-full flex flex-col '>
                <div className='h-full mb-2'>
                    ...
                    <section className=' h-full w-full flex flex-col items-center '>
                        <div className=" lg:w-[75%] h-full w-fit mt-0 lg:mt-3  bg-slate-50  flex justify-center items-start rounded-lg ">
