    ...
    return (
        <div className="relative ">
            <header className='bg-yellow-300'>
                <nav className=" border-gray-100 px-4 lg:px-6 py-0 dark:bg-gray-800 h-fit">
                    <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                        ...
                        <div className="flex items-center lg:order-2 mt-10">
                            <BellNotifications />
                            <UserDropDown />
                        ...
                        <div className={`${isMenuOpen ? 'block' : 'hidden'} h-full bg-yellow-300 justify-between items-center w-full lg:flex lg:w-auto lg:order-1`} id="mobile-menu-2">
