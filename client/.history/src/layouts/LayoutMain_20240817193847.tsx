        ...
        <div className="relative h-screen bg-gray-200">
            ...
            <main className=' bg-purple-400 h-[91.2%]'>
                <div>
                    ...
                    */}
                    <section className=' h-[91.2%] w-full flex flex-col items-center  bg-[url("https://cdn6.campograndenews.com.br/uploads/noticias/2022/10/19/dd6af8b54f66316947c46611fbfa04dd7adbec0e.jpg")] bg-no-repeat'>
                        {/* Div para a imagem de fundo */}
                        <div className=" lg:w-[75%] h-[91.2%] w-full  mt-5  bg-slate-100  flex justify-center items-start rounded-lg ">
