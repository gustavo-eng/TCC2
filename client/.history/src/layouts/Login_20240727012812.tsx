    ...
    return (
        <>
            <div className='flex flex-col lg:flex-row h-screen'>
                ...
                <div className="lg:flex-shrink-0 lg:w-1/3 flex flex-col justify-between items-center bg-white lg:h-auto px-6 lg:px-16 h-screen overflow-y-auto bg-purple-400">
