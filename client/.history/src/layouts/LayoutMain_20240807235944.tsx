import { CalendarPlus, CurrencyCircleDollar, HandPalm, Student } from '@phosphor-icons/react';
...
export default function LayoutMain({ componentName = 'tab' }) {
    ...
    const tabs = useMemo(
        () => [
            ...
            {
                id: 'allStudents',
                icon: <Student size={25} weight="duotone" />,
                component: <div>Aqui vai os estudantes</div>,
            }
        ],
        [],
    );
