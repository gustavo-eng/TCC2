...
export default function LayoutMain({
    ...
    useEffect(() => {
        const defaultTabIndex = tabs.findIndex(tab => tab.id === 'map');
        setSelectedTab(defaultTabIndex !== -1 ? defaultTabIndex : 0);
    }, [tabs, setSelectedTab]);
            ...
            <main>
                <section>
                    <div className="w-full h-full flex justify-center">
                        {tabs[selectedTabIndex]?.component ? tabs[selectedTabIndex].component : <div>First</div>}
                    </div>
                </section>
            </main>
        </div>
