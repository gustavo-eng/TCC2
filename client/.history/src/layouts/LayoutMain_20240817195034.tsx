    ...
    return (
        <div className="relative h-screen bg-gray-200">
            ...
            <main className=' bg-purple-300 h-[91.2%] w-full   flex flex-col justify-start'>
                <div className="relative inset-0  bg-[url('https://static.wixstatic.com/media/5b4b97_70690e975d24451ab11460a7720e3270~mv2.jpg/v1/fill/w_1899,h_543,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/5b4b97_70690e975d24451ab11460a7720e3270~mv2.jpg')] bg-cover bg-no-repeat bg-bottom opacity-70 z-0"></div>
