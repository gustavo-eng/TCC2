                    ...
                    <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                        ...
                        <div className={`${isMenuOpen ? 'block' : 'hidden'} justify-between items-center w-full lg:flex lg:w-auto lg:order-1`} id="mobile-menu-2">
                            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                                <Tab.Group selectedIndex={selectedTabIndex} onChange={setSelectedTab}>
                                    <Tab.List className="flex overflow-x-auto p-2">
                                        {tabs.map((tab, index) => (
                                            <Tab
                                                ...
                                                className={({ selected }) =>
                                                    twMerge(
                                                        'min-w-[9rem] py-2.5 font-bold leading-5 hover:text-green-700 focus:outline-0 flex gap-2 justify-center items-center transition duration-500',
                                                        selected
