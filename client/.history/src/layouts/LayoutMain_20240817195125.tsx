...
export default function LayoutMain({ componentName = 'tab' }) {
    ...
    return (
        <div className="relative h-screen bg-gray-200">
            ...
            <main className=' bg-purple-300 h-[91.2%] w-full   flex flex-col justify-start'>

            <div className="relative z-10 w-full h-full flex flex-col items-center">
                <div className="absolute inset-0 z-1  bg-[url('https://static.wixstatic.com/media/5b4b97_70690e975d24451ab11460a7720e3270~mv2.jpg/v1/fill/w_1899,h_543,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/5b4b97_70690e975d24451ab11460a7720e3270~mv2.jpg')] bg-cover bg-no-repeat bg-bottom opacity-70 z-0"></div>
                    <section className=' h-full w-full z-10 flex flex-col items-center  '>
                        {/* Div para a imagem de fundo */}
                        <div className=" lg:w-[75%] h-full w-full  mt-5  bg-slate-100  flex justify-center items-start rounded-lg ">
