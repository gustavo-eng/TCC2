...
export default function LayoutMain({ componentName = 'tab' }) {
    ...
    return (
        <div className="relative h-screen bg-gray-200">
            ...
            <main className=' bg-purple-400 h-[91.2%] w-full  bg-[url("https://static.wixstatic.com/media/5b4b97_70690e975d24451ab11460a7720e3270~mv2.jpg/v1/fill/w_1859,h_543,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/5b4b97_70690e975d24451ab11460a7720e3270~mv2.jpg")] bg-no-repeat bg-opacity-45'>
                <div>
