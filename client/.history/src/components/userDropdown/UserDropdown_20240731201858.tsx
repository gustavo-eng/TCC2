                ...
                {isOpen && (
                    <div className='transition-[opacity, margin] rounded-t-sm duration absolute right-[0.0rem] mt-1 bg-white shadow-md rounded-sm p-1 min-w-[14rem] z-10'>
                        ...
                        <div className='py-1 first:pt-2 last:pb-1'>
                            ...
                            <button
                                className=" w-full my-1 flex items-center justify-center font-semibold gap-x-1.5 py-2 px-3 rounded-lg text-sm  hover:bg-gray-100  dark:text-white focus:outline-none dark:focus:bg-headerDark"
