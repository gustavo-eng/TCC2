    ...
    return (
        <>
            <div className='bg-white relative inline-block'>
                ...
                {isOpen && (
                    <div className='transition-[opacity, margin] duration absolute right-[0.0rem] mt-1 bg-white shadow-md rounded-sm p-1 min-w-[14rem] z-10'>
                        <div className='py-1 px-1 bg-gray-100 rounded-lg'>
                            <p className=''>
                                Preferencesff
                            </p>
