                ...
                <input
                    ...
                    className={twMerge(
                        `w-full h-10 border text-sm text-gray-700 rounded-lg dark:bg-blockDark dark:text-white brightness-105 px-2 disabled:cursor-not-allowed focus:outline-0 ${errorMessage
                            ...
                            : 'border-gray-500 hover:border-green-900 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset'
                        } ${icon ? 'pl-10 pb-1' : ''}`,
                        inputClassName,
                    )}
                />
