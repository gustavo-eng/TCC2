    ...
    return (
        <div className="text-white mr-1">
            ...
            <div
                ...
                className={`z-20 ${isOpen ? 'block' : 'hidden'}  absolute  divide-y rounded-lg mr-3 dark:bg-gray-800 dark:divide-gray-700`}
                aria-labelledby="dropdownNotificationButton"
            >
                <div className="block px-1 py-2 font-medium text-center sm:flex sm:text-purple-500 text-red-700 rounded-t-lg  dark:bg-gray-800 ">
                    Notifications
                </div>
