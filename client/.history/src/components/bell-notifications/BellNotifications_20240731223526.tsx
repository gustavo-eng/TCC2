    ...
    return (
        <div className="text-white mr-1">
            <button
                ...
                className="relative flex items-center text-sm font-medium text-center text-gray-500 hover:text-gray-900 focus:outline-none dark:hover:text-white dark:text-gray-400 mb-2"
                type="button"
            ...
            >
                ...
                <div className="absolute  w-3 h-3 bg-red-500 border-2 border-white rounded-full -top-0.5 left-2.5  dark:border-gray-900"></div>{/* bolinha red */}
            </button>
            ...
            >
                <div className="  py-2 font-medium text-center  rounded-t-lg  dark:bg-gray-800  lg:text-pink-500">
                    Notifications
                </div>
...
/*
<div className="block px-1 py-2 font-medium text-center text-gray-700 rounded-t-lg bg-gray-50 dark:bg-gray-800 dark:text-white custom:bg-customYellow">
                    Notifications
                </div>
