    ...
    return (
        <div className="text-white mr-1">
            ...
            <div
                ...
                className={`z-20 ${isOpen ? 'block' : 'hidden'}  absolute left-0 w-screen lg:left-1/2 lg:w-fit   bg-white divide-y  rounded-lg mr-0 lg:mr-3 dark:bg-gray-800 dark:divide-gray-700`}
