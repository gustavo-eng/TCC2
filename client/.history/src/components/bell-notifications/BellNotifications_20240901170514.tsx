                ...
                <div className="flex px-4 py-2 hover:bg-gray-700 ">
                  ...
                  <div className="w-full pl-3">
                    ...
                    <div className="flex flex-row justify-end">
                      <Button className="bg-green-500 hover:bg-green-600 rounded-md text-sm  p-1.5 mr-3" label="Aceitar"/>
                      <Button className="bg-red-600/75  hover:bg-red-900 rounded-md text-sm p-1.5" label="Aceitar"/>
                    </div>
                  </div>
                </div>
              </div>
