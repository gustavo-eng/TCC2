...
export default function BellNotifications() {
    ...
    return (
        <div className="text-white mr-1 bg-red-500">
            <button
            ...
            <div
                ...
                className={`z-20 ${isOpen ? 'block' : 'hidden'} absolute w-full max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-800 dark:divide-gray-700`}
