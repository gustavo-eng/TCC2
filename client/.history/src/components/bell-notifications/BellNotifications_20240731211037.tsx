...
export default function BellNotifications() {
    ...
    return (
        <div className="text-white mr-1 w-full">
            <button
            ...
            <div
                ...
                className={`z-20 ${isOpen ? 'block' : 'hidden'} absolute  max-w-sm bg-white divide-y mr-32 rounded-lg shadow dark:bg-gray-800 dark:divide-gray-700`}
