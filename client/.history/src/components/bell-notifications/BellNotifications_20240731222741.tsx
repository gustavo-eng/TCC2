    ...
    return (
        <div className="text-white mr-1">
            ...
            <div
                ...
                className={`z-20 ${isOpen ? 'block' : 'hidden'}  absolute w-screen left-0 lg:left-1/2 lg:w-fit   divide-x-2  rounded-lg mr-0 lg:mr-3 dark:bg-gray-800 dark:divide-gray-700`}
