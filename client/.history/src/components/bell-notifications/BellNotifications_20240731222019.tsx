    ...
    return (
        <div className="text-white mr-1">
            ...
            <div
                ...
                className={`z-20 ${isOpen ? 'block' : 'hidden'}  absolute  left-1/2  bg-white divide-y  rounded-lg mr-3 dark:bg-gray-800 dark:divide-gray-700`}
                aria-labelledby="dropdownNotificationButton"
            >
                <div className="  py-2 font-medium text-center  rounded-t-lg  dark:bg-gray-800 w-screen left-0 lg:w-full lg:text-pink-400 ">
                    Notifications
                </div>
