                    ...
                    <a href="#" className="flex px-4 py-2 hover:bg-gray-700 ">
                        ...
                        <div className="w-full pl-3">
                            ...
                            <div className="flex flex-row justify-end">
                                <button className="bg-green-500 hover:bg-green-700 rounded-sm text-sm  p-1 mr-3">Aceitar</button>
                                <button className="bg-red-600/75  hover:bg-red-900 rounded-sm text-sm p-1">Recusar</button>
                            </div>
                        </div>
                    </a>
