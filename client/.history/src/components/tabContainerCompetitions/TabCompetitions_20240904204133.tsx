  ...
  return (
    <div>
      ...
      <div className=" flex flex-row   justify-center items-end  mb-5 pr-2 flex-wrap">
        ...
        {user.role == "fprj" && (
          <Button
            className="ml-1 lg:mt-0 bg-green-400 hover:bg-green-500  w-fit  lg:w-fit py-2 px-1 rounded-md flex flex-row "
            label="Evento"
            classNameLabel="text-sm"
            onClick={openModalEvent}
          >
            <Plus size={18} className="bg-green-400/10   p-0.5 rounded-xl ml-1" />
          </Button>
        )}
      </div>
