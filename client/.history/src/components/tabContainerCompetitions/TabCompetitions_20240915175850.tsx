 ...
 // Filter events based on name and start date
  const filteredEvents = events?.filter(
    (el) =>
      ...
      (searchDate ? formatDate(String(el?.startDate)) === searchDate : true)
  );
  ...
  return (
    <div>
      ...
      <div className="w-full flex flex-row justify-center items-end  mb-5 pr-1.5 flex-wrap bg-red-400">
        <Input
      ...
      <div className="w-screen grid grid-cols-2 lg:grid-cols-4 gap-1">
