    ...
    return (
        <div>
            ...
            <div className=" flex flex-wrap   w-full  ">
                ...
                <CardAction titleButton="inscrever-se"  description="adsfafadsfadsfdaiojfoiajfoiajoifafasdfjaisojfoiajfoiajfoiajoifjaoifjaoijfoiajd" />
                <CardAction titleButton="inscrever-se" idEvent="23" onClick={}  />
