...
export default function TabCompetitions() {
  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full flex flex-row justify-center items-end  mb-5 pr-1.5 flex-wrap bg-red-300 ">
        <Input
          className=" flex flex-row items-end h-full bg-purple-300 lg:w-[50%] w-full lg:m-3  ml-4"
          inputClassName="rounded-md border-gray-400 hover:border-green-500 bg-purple-300 h-full "
