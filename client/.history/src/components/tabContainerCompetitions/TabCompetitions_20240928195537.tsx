...
export default function TabCompetitions() {
  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full flex flex-row justify-center items-center  mb-5 pr-1.5 flex-wrap bg-red-300 ">
        <Input
          className=" flex flex-row items-center lg:w-[50%] w-full lg:m-3  ml-4"
