    ...
    return (
        <div className=" flex flex-wrap justify-start  w-full  ">
            ...
            <CardAction btn={false}>
                <Button className="w-full h-5 lg:h-7 mb-1 mt-2 rounded text-white font-normal text-xs lg:text-sm" label={"FFDD"} />
            </CardAction>
        </div>

    )
}
//                        <Button className="w-full h-5 lg:h-7 mb-1 mt-2 rounded text-white font-normal text-xs lg:text-sm" label={titleButton} />
