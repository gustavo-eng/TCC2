    ...
    return (
        <div>
            ...
            <div className=" flex flex-wrap   w-full  ">
                ...
                <CardAction titleButton="inscrever-se"  idEvent="1" onClick={() => console.log('2')} description="adsfafadsfadsfdaiojfoiajfoiajoifafasdfjaisojfoiajfoiajfoiajoifjaoifjaoijfoiajd" />
