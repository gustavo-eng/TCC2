    ...
    return (
        <div>
            ...
            <div className=" flex flex-wrap   w-full  ">
                ...
                <CardAction   idEvent="1" onClick={() => handleOpenModalRegistration("1")}
                ...
                />
                <CardAction titleButton={`${isAthlet ? 'INSCREVER-SE' : 'VER INSCRIÇÕES'}`} idEvent="2"  onClick={() => handleOpenModalRegistration("2")}/>
                <CardAction description="adsfauhasudhfdfuahfuaihi"  titleButton={`${isAthlet ? 'INSCREVER-SE' : 'VER INSCRIÇÕES'}`}/>
                <CardAction description="adsfauhasudhfdfuahfuaihi"  titleButton={`${isAthlet ? 'INSCREVER-SE' : 'VER INSCRIÇÕES'}`}/>
            </div>
