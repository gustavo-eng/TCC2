    ...
    return (
        <div>
            ...
            <div className=" flex flex-wrap   w-full  ">
                ...
                <CardAction titleButton="inscrever-se"  idEvent="1" description="adsfafadsfadsfdaiojfoiajfoiajoifafasdfjaisojfoiajfoiajfoiajoifjaoifjaoijfoiajd" />
                <CardAction titleButton="inscrever-se" idEvent="2"  onClick={() => console.log('nophing')}/>
