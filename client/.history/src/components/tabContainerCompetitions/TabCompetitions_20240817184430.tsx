...
export default function TabCompetitions() {
    ...
    return (
        <div>
            <div className=" flex flex-row   justify-center items-end  mb-5 pr-2">
                ...
                <Button className="ml-2 mb-0.5 bg-green-500 hover:bg-green-600 h-[4.5vh] w-[6vw] rounded flex flex-row items-center justify-evenly" label="Evento">
                    <Plus  size={18} className="bg-green-600   p-0.5 rounded-xl "/>
                </Button>
