...
export default function TabCompetitions() {
  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full flex flex-row justify-center items-center  mb-2 pr-1.5 flex-wrap bg-red-300 h-fit ">
        <Input
          className=" flex flex-row lg:w-[50%] w-full lg:m-3  ml-4 h-fit"
          spanInputClassName=""
          inputClassName="rounded-md border-gray-400 hover:border-green-500 m-0 p-0"
        ...
        {user.role == "fprj" && (
          <Button
            className="ml-1 lg:mt-0 bg-green-500/85 hover:bg-green-500  w-fit  lg:w-fit py-2 px-2 rounded-md flex flex-row justify-between bg-red-400"
            label="Evento"
