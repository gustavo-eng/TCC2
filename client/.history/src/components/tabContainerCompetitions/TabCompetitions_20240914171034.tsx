...
export default function TabCompetitions() {
  ...
  return (
    <div>
      ...
      {events?.map((el) => {
        return <div>{el?.price ?? "Nao tem"}</div>;
      })}
      <ModalRegistration
          ...
          return (
            <Fragment key={idx}>
              <CardAction
                ...
                startDate={formatDate(String(el?.startDate)) + 'fsdfasfd'}

                idEvent={String(el?.idEvent)} // Passar id do evento como parametro
...
/*
{
    ...
    "price": 567.23,
    "startDate": "2024-06-21T00:57:42.000Z",
    "endDate": "2024-06-21T00:57:42.000Z",
    "neighborhood": "Conjunto Uniao",
    "street": "Dario Ribeiro",
    "number": 23,
    "city": "Blumenau",
    "createdAt": "2024-09-14T18:35:00.000Z",
    "updatedAt": "2024-09-14T18:35:00.000Z",
    "idTypeEvent": 1,
    "typeEvent": {
        "idTypeEvent": 1,
        "type": "Brasileiro",
