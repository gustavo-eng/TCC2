  ...
  return (
    <div className="lg:w-full w-screen">
      ...
      <div className="w-full flex flex-row justify-center items-end gap-2 mb-2 pr-1.5 flex-wrap h-fit ">
        ...
        {user.role == "fprj" && (
          <Button
            className="lg:mt-0  bg-green-500/85 hover:bg-green-500  lg:w-fit w-full py-2 lg:px-4 rounded-md flex flex-row lg:justify-between justify-center ml-3 lg:gap-0 gap-3 h-full"
            label="Evento"
