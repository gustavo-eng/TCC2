...
export default function FileInput({
    ...
    return (
        <div>
            ...
            <section
                className="w-full flex flex-row justify-between bg-green-100 mt-1.5 p-1 rounded items-center">
                <div className="flex">
                    <FileArrowDown size={25} color="#0c3285" />
                    <span className="bg-yellow-200 flex text-xs items-center">{fileName}</span>
                </div>
