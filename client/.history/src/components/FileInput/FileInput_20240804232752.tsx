...
export default function FileInput({
    ...
    return (
        <div>
            ...
            <form action=""
                className={twMerge("bg-green-100 flex flex-col justify-center items-center h-[200px] rounded-md border-2 border-dashed cursor-pointer border-green-700", classNameForms)}
