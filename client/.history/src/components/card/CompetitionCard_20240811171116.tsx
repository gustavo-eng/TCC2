      ...
      <div className="flex justify-between items-end mt-4 h-full flex-wrap ">
        ...
        {status !== 'Aprovado' && (
            <div className='flex flex-col items-center justify-end '>
                ...
                <Button className="w-full  h-7  bg-red-400 hover:bg-red-700 rounded text-white font-normal text-xs lg:text-sm " classNameLabel='text-[14px]' label={"Remover"} onClick={onRemove}/>
            </div>
        )}
    </div>
  );
