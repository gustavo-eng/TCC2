...
const CompetitionCard: React.FC<CompetitionCardProps> = ({
  ...
  return (
    <div className="bg-white shadow flex flex-col justify-start w-[25vw] lg:w-[18vw] rounded-md m-1  h-fit p-1">
      <div id={idPayment?.toString()} className='hidden'>Id: {idPayment}ffffffffffff</div>
