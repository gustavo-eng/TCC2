...
const CompetitionCard: React.FC<CompetitionCardProps> = ({
  ...
  return (
    <div className=" bg-white flex flex-col justify-between w-[30vw]  lg:w-[18vw] rounded-md m-1 h-fit p-1">
    ...
    {status == 'Rejeitado' && description && (
      <div className='p-1 bg-red-300  lg:h-fit'>
            ...
            <p className='text-[10px] lg:text-xs break-words max-w-full'>{description}</p>
      </div>
    )}
