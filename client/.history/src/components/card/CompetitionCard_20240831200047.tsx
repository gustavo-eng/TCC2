...
const CompetitionCard: React.FC<CompetitionCardProps> = ({
  ...
  return (
    <div className="bg-white shadow flex flex-col justify-start w-[30vw] lg:w-[18vw] rounded-md m-1  h-fit p-1">
      ...
      <div className="flex justify-between items-center w-full flex-wrap">
        ...
        <span className="text-green-700 text-md font-bold">{price} R$</span>
      </div>
