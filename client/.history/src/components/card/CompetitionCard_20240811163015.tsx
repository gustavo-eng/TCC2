    ...
    <div className=" bg-gray-100 rounded shadow-lg w-fit m-1">
      ...
      <div className="flex justify-between items-center mt-4 ">
        ...
        */}
        ...
        {status !== 'Aprovado' && (
            <div className='flex flex-row  w-[160px] items-center bg-gray-500'>
                <Button className="w-[120px] h-5 lg:h-7 rounded text-white font-normal text-xs lg:text-sm  "  label={"Editar"} onClick={onEdit}/>
                <Button className="w-[120px] h-5 lg:h-7 m-1 rounded text-white font-normal text-xs lg:text-sm "  label={"Editar"} onClick={onEdit}/>
            </div>
        )}
