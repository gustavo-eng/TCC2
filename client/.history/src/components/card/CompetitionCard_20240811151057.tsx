...
const CompetitionCard: React.FC<CompetitionCardProps> = ({
  ...
  return (
    <div className="p-1 bg-gray-100 rounded shadow-lg w-80 m-1">
      <div className="flex justify-between items-center">
        <h3 className="font-bold text-lg">{name}</h3>
        <span className="text-md font-bold">{price} R$</span>
      </div>
      <div className="text-sm text-gray-600 mt-0">
        <p className='bg-green-300 text-xs font-medium'>  Horário início - Horário fim
            Data início: {startDate} {startTime}  • Data fim: {endDate}
        </p>
        {/*
        <p>
