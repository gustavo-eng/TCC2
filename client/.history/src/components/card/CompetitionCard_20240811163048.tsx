        ...
        */}
        ...
        {status !== 'Aprovado' && (
            <div className='flex flex-row  w-full items-center bg-gray-500'>
                <Button className="w-[80px] h-3 lg:h-7 rounded text-white font-normal text-xs lg:text-sm  "  label={"Editar"} onClick={onEdit}/>
                <Button className="w-[80px] h-3 lg:h-7 m-1 rounded text-white font-normal text-xs lg:text-sm "  label={"Editar"} onClick={onEdit}/>
            </div>
        )}
