    ...
    {status == 'Rejeitado' && description && (
      ...
      <div className="flex justify-between items-end mt-4 h-full">
        <div className='pl-1 mb-1.5'>
            {status == 'Pendente' &&  <span className="bg-gray-400 text-gray-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded !dark:bg-gray-700 !dark:text-gray-400 border border-gray-500">{status}</span>}
