  ...
  return (
    <div className=" bg-gray-100 rounded shadow-lg w-fit m-1">
      ...
      <div className="flex justify-between items-center mt-4 bg-red-400">
        <span className={`px-2 py-1 rounded-full text-sm bg-white text-black ${status === 'Rejeitado' ? 'border-red-400' : status === 'Aprovado' ? 'bg-green-500 text-white' : 'bg-red-500 text-white'}`}>
          {status}s
        </span>
