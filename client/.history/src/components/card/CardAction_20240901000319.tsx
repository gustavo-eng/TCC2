        ...
        <>
            <div className="bg-white flex flex-col justify-between w-[30vw] lg:w-[16vw] rounded-md m-1 shadow pb-1 ">
                ...
                {btn ? (
                    <div className="pr-1 pl-1">
                        <Button
                            className="w-full h-5  lg:h-8 rounded-md bg-green-500 hover:bg-green-600/90 text-white font-normal text-xs lg:text-sm mb-1 mt-2"
                            label={titleButton}
                            classNameLabel="text-xs lg:text-xl"
                            onClick={onClick}
                        />
                    </div>
                ) : children}
