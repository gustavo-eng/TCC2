...
const CompetitionCard: React.FC<CompetitionCardProps> = ({
  ...
  return (
    <div className=" bg-white flex flex-col justify-between w-[30vw]  lg:w-[18vw]  rounded-md m-1 h-[54vh] lg:h-fit p-1">
    ...
    {status == 'Rejeitado' && description && (
      <div className='p-1 bg-red-300  lg:h-fit'>
      ...
      <div className="flex justify-between items-end mt-4 h-fit flex-wrap ">
        ...
        {status !== 'Aprovado' && (
            <div className='flex flex-col items-center justify-end p-1'>
                <Button className="w-full h-2 rounded text-white font-normal text-xs lg:text-sm" classNameLabel='text-[14px]'  label={"Editar"} onClick={onEdit}/>
