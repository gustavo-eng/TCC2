        ...
        <>
            <div className="bg-white flex flex-col justify-between  h-fit w-[30vw] lg:w-[18vw] rounded-md m-1 ">
                ...
                <div className=" pr-1 pl-1 w-full">
                    <h1 className="font-semibold lg:text-lg">Description</h1>
                ...
                <div className="pr-1 pl-1">
                    <button className="bg-green-600 w-full h-7 mb-1 mt-2 rounded text-white font-normal text-xs lg:text-sm hover:bg-green-800 ">
                        Ver inscricoes
                    </button>
                </div>
            </div>
