...
const CompetitionCard: React.FC<CompetitionCardProps> = ({
  ...
  console.warn('path image')
  console.warn(`http://localhost:3001/${idAthlete}/${String(voucherPath).split('\\').pop()}`)
  return (
    <div className="bg-white shadow flex flex-col justify-start  lg:w-[15vw] rounded-md m-1 h-fit p-1">
      ...
      <div className="mt-2 h-36">
        <img
          src={voucherPath ? `http://localhost:3001/${idAthlete}/${String(voucherPath).split('\\').pop()}` : "src/assets/olimpicGame.webp"}
          alt="img"
