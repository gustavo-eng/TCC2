...
const CompetitionCard: React.FC<CompetitionCardProps> = ({
  ...
  return (
    <div className="bg-white flex flex-col justify-between w-[30vw] lg:w-[18vw] rounded-md m-1 min-h-[54vh] lg:h-fit p-1">
      ...
      {status !== 'Aprovado' && (
        <div className="flex flex-col items-center justify-end p-1">
          ...
          />
          <Button
            className="w-full h-7 m-1  hover:bg-red-700 rounded text-white font-normal text-xs lg:text-sm"
            classNameLabel="text-[14px]"
            label="Remover"
            onClick={onRemove}
          />
