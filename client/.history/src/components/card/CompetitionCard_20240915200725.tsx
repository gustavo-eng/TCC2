    ...
    <div className="bg-white shadow flex flex-col justify-start  lg:w-[15vw] rounded-md m-1 h-fit p-1">
      ...
      {status == 'Rejeitado' && !description && (
        <div className="p-1  lg:h-fit">
          ...
          <p className="text-[8px] lg:text-xs break-words max-w-full">{description}fdfafdsfsdgsfdgdasffafasdfafiajsfoajfoidajofjasifdifjaodfoajfadsjfaijfoidasjfoijfoiasdjjofiajo</p>
        </div>
      )}
