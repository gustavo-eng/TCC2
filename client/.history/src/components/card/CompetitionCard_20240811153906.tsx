    ...
    <div className=" bg-gray-100 rounded shadow-lg w-fit m-1">
      ...
      <div className="flex justify-between items-center mt-4 ">
        ...
        */}
        ...
        <span class="bg-blue-100 text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-200 dark:text-blue-400 border border-blue-400">Default</span>
