  ...
  return (
    <>
      <div className="bg-white flex flex-col justify-between  lg:w-[16vw] h-fit rounded-md m-1 shadow pb-1 ">
        ...
        {btn ? (
          <div className="pr-1 pl-1 bg-gray-400">
            <Button
              className="w-full h-7   rounded-md bg-green-500 hover:bg-green-600/90 text-white font-normal text-xs lg:text-sm mb-0 mt-2"
              label={titleButton}
