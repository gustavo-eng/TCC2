...
import { extractHour } from "../../utils/fornatDate";
            ...
            <div className="bg-white flex flex-col justify-between  lg:w-[16vw] rounded-md m-1 shadow pb-1 ">
                ...
                <div className="pr-1 pl-1">
                    <div className="flex flex-col mb-2 justify-stretch">
                        <p className="text-xs mb-0">Data de inicio: {startDate || "xx/xx/xxxx"} Horário: {extractHour(startDate as string) || "hh:mm:yyyy"}</p>
