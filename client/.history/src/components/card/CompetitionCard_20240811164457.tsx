      ...
      <div className="flex justify-between items-center mt-4 ">
        ...
        {status !== 'Aprovado' && (
            <div className='flex flex-row  w-full items-center justify-end ml-6'>
                ...
                <Button className="w-[80px]  h-7 m-1 bg-red-400 hover:bg-red-700 rounded text-white font-normal text-xs lg:text-sm " classNameLabel='text-[15px]' label={"Remover"} onClick={onRemove}/>
            </div>
        )}
      </div>
    </div>
