...
export default function CardAction({
   ...
   const detectImg = () => {
        ...
        } else if(name?.trim().toLowerCase().includes('mund') || name?.trim().toLowerCase().includes('int') || name?.trim().toLowerCase().includes('cir')) {
            ...
            <div className="bg-white flex flex-col justify-between  lg:w-[16vw] h-fit rounded-md m-1 shadow pb-1 ">
                ...
                <div className="lg:p-1 p-0 m-0  h-fit">
                    <img
                        src={srcImg}
                        alt="img"
                        style={{ width: "100%", height: `${srcImg.includes('fprj') ?'190px' : '60%' }` }}
