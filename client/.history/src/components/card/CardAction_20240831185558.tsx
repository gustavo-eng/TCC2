...
export default function CardAction({
    ...
    return (
        <>
            <div className="bg-white flex flex-col justify-between w-[30vw] lg:w-[12vw] rounded-md m-1 shadow pb-1 ">
                ...
                {btn ? (
                    <div className="pr-1 pl-1">
                        <Button
                            className="w-full bg-green-600/90 hover:bg-green-700/90 h-5 lg:h-7 mb-1 mt-2 rounded text-white font-normal text-xs lg:text-sm"
                            label={titleButton}
                            onClick={onClick}
                        />
                    </div>
