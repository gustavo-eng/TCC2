    ...
    <div className="bg-white flex flex-col justify-start w-[30vw] lg:w-[18vw] rounded-md m-1  h-fit p-1">
      ...
      {status !== 'Aprovado' && (
        <div className="flex flex-col items-center justify-end p-1">
          <Button
            className="w-full h-8 rounded text-white font-normal text-xs lg:text-sm"
            classNameLabel="text-[14px]"
            label="Editar"
            onClick={onEdit}
          />
          <Button
            className="w-full h-7 m-1 bg-red-400 hover:bg-red-500/80 rounded text-white font-normal text-xs lg:text-sm"
            classNameLabel="text-[14px]"
            label="Remover"
            onClick={onRemove}
          />
