...
function TableListRegistrations({
  ...
  const [optionsGender2, setOptionsGender2] = useState<any>();
  ...
  const onGridReady = useCallback(() => {
    ...
    setOptionsGender2(structNestedOptions(tableJSON, ['Category', 'gender']))
    setOptionsGender2([{value: "", label: 'Todos'}])
  }, [tableJSON]);
