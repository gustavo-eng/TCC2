...
function TableListRegistrations({
  ...
  const filterGenderStartsWith = useCallback((value: string) => {
    // Verifique se o valor não está vazio
    if (!value) {
      // Remove o filtro se não houver valor
    ...
    />
      <div className="flex flex-col lg:flex-row justify-start mt-2">
        ...
        <Select
          ...
          onChange={(e) => filterGenderStartsWith(e.target.value)} // Certifique-se de passar o valor correto
        />
