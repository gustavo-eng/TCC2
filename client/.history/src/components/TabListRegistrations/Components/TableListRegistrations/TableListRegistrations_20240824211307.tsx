...
const validateButton = (onClick: () => void) => {
  return (
    <div className="h-full w-full flex flex-col items-center justify-center">
      <Button
        className="h-[60%] w-[5vw] p-1 flex flex-col justify-center items-center text-center rounded hover:bg-blue-600 bg-blue-600/70"
        label="Validar"
...
function TableListRegistrations({
  ...
  return (
    <div  className={`w-full h-full  ${themeClass}`}>
        ...
        inputClassName="rounded bg-red-500 w-full lg:w-[15vw] h-[4vh] mr-[-4px]"
        type="text"
        id="filter-text-box"
