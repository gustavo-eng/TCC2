...
function TableListRegistrations({
  ...
  const openModalValidate = (params: any) => {
   console.warn('params 333 ', params)
    return setIsModalValidate(true)
  };
  ...
  const [colDefs] = useState<ColDef[]>([
    ...
    {
      headerName: "Acao",
      cellRenderer: (params: any) => validateButton(() => openModalValidate(params)),
      cellStyle: { textAlign: "center" },
      flex: 0.4,
    },
  ]);
