...
const CardsGym: React.FC<CardProps> = ({
  ...
  return (
    <div className=" m-1 w-fit p-3 bg-white rounded-lg shadow-md border-l-[9px] border-l-indigo-500  border-gray-200 hover:bg-gray-100">
      <div className="flex items-start">
        <div className="h-full bg-green-500 rounded-l-lg" />
        <div className="ml-4">
          <h2 className="text-xl bg-purple-300 text-center  font-semibold mb-2">{titulo}</h2>
