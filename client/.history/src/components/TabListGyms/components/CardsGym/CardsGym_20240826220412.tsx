...
const CardsGym: React.FC<CardProps> = ({
  ...
  return (
    <div className=" m-1 w-fit p-2 bg-white rounded-lg shadow-md border-l-[9px] border-l-green-400  border-gray-200 hover:bg-gray-50">
      <div className="flex items-start">
        ...
        <div className="ml-4">
          ...
          <div className="grid grid-cols-2 gap-2 mr-2 text-gray-500">
            <div className=''>
