...
const CardsGym: React.FC<CardProps> = ({
  ...
  return (
    <div className=" m-1 w-fit p-3 bg-white rounded-lg shadow-md border-l-[9px] border-l-green-400  border-gray-200 hover:bg-gray-100">
      <div className="flex items-start">
        <div className="h-full bg-green-500 rounded-l-lg" />
        <div className="ml-4">
          <h2 className="text-xl -tracking-normal text-center font-semibold mb-4 text-green-700">{titulo}</h2>
          <div className="grid grid-cols-2 gap-4 mr-2 text-gray-500">
            <div className=''>
