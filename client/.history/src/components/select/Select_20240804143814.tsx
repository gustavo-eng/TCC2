    ...
    return (
        <>
            <form className="max-w-sm mx-auto">
                ...
                <select id="countries" className="text-black bg-gray-100  border-gray-700  text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
