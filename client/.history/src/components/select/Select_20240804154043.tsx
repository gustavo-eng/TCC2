    ...
    return (
        <div className="relative bg-white mt-7 w-full">
            ...
            <div className="relative">
                <select
                    id="countries"
                    className="appearance-none outline-none font-normal text-gray-600 bg-gray-100 border border-green-900 text-sm rounded-none focus:ring-0 focus:border-green-500 block w-full p-1 pr-10 dark:focus:border-green-600"
                >
