    ...
    return (
        <div className="relative bg-white mt-7 w-[190px]">
            ...
            <div className="relative">
                <select id="countries" className=" outline-none font-normal text-gray-600 bg-gray-100 border border-green-900 text-sm rounded focus:ring-green-500 focus:border-green-500 block w-full p-1 pr-10 dark:focus:ring-green-500 dark:focus:border-green-600">
