...
export default function Select({
    ...
    return (
        <div className={twMerge("bg-white mt-7 w-full", className)}>
            ...
            <select
                className={twMerge("outline-none font-normal text-gray-500 bg-gray-200 border border-green-900 text-sm rounded focus:ring-green-500 focus:border-green-500 block w-full p-1.5 dark:focus:ring-green-500 dark:focus:border-green-600", classNameSelect)}
                {...props}
            >
