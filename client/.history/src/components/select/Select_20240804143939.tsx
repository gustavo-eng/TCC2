    ...
    return (
        <>
            <form className="max-w-sm mx-auto bg-red-400 mt-3">
                ...
                <select id="countries" className="text-black bg-gray-200  border-gray-700  text-sm rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5   dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
