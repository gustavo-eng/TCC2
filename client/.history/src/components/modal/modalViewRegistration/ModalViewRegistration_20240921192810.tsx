    ...
    return (
        <div>
            ...
            <div className="flex flex-col w-full p-1">
                <p className="font-semibold text-green-700 mb-4">{voucherPath.Event.descripton}fff</p>
                ...
                <div className="flex flex-row mb-2">
                    <p className="font-medium">Comprovante </p> {status && <StatusBadge status={status}/>}
