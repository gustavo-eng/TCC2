...
function ModalViewRegistration({
    ...
    console.log('idRegistration ', idRegistration)
    useEffect(() => {
        console.log('555555 regis ',getObjectByIdPayment(registration, 69) )
        setVoucherPath(getObjectByIdPayment(registration, idRegistration));
    }, [idRegistration])
