  ...
  const onSubmit = async (data: registerEvent) => {
    ...
    try {
      ...
      const formattedData = {
        ...
        startDate:dataStart, // Formato desejado
        //endDate: format(data.endDate, 'yyyy-MM-dd HH:mm:ss'), // Formato desejado
        endDate: dataEnd, // Formato desejado
      };
          ...
          <div className=" flex flex-rol justify-between mt-2">
            <div className=" flex  gap-2 mb-2">
              <TimerPicker
                ...
                value={dataStart}
                onChange={(date) => setDataStart(date.target.value)}
              ...
              <TimerPicker
                ...
                value={dataEnd}
                onChange={(date) => setDataEnd(date.target.value)}
