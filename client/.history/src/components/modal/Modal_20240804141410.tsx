...
export default function Modal({
    ...
    return (
        <div
            tabIndex={-1}
            aria-hidden="true"
            className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto overflow-x-hidden bg-gray-500 bg-opacity-45 rounded-md"
        ...
        >
            ...
            >
                ...
                <div className="relative rounded shadow bg-gray-300">
                    {/* Modal header */}
                    <div className=" flex items-center justify-between p-1 rounded-none border-gray-600 h-12">
