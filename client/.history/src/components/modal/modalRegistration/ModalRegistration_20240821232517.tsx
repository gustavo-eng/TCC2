...
export default function ModalRegistration({
    ...
    */
    ...
    console.log('id Event renderizado ** ', idEvent)
        ...
        <>
            ...
            >
                <div className=" w-full h-full p-1">
                    <div className="p-0.5">
                        {/*Melhorar */}
                        <h1 className="text-gray-500 font-medium text-[18px] ">{findEventById(mockData, idEvent?.toString()).nameCompetition || "Name event"}</h1>
                    </div>
                    {startDate && (
