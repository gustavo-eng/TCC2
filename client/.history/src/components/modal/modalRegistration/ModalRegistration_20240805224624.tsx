        ...
        <>
            ...
            >
                <div className=" w-full h-full p-1">
                    ...
                    {startDate && (
                        <div className=" flex flex-row">ff
                            {/* Obrigatorio pois eh para competicao */}
                            {startDate && <div className="mr-10">Data inicio: {startDate} as {startTime} </div>}
                            {endDate && <div className="">Data fim: {endDate} as hh:mm:yyyy</div>}
                        </div>
                    )}
                    {description && (
                        <div >
