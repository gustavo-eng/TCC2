            ...
            >
                ...
                <div className="relative rounded shadow bg-gray-300">
                    ...
                    <div className="flex flex-row justify-end p-1  border-t  rounded-b">
                        ...
                        <button
                            type="button"
                            className="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 text-gray-400   "
                            onClick={onClose}
                        >
                            Decline
                        </button>
