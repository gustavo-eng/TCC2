                    ...
                    <div className="flex flex-row justify-end bg-white   rounded-b-lg  ">
                        {hasFooter && (
                            <div className='mr-2 mt-4'>
                                <Button onClick={onClickOK} label={labelBtnOk || 'Submit'} type="button" className='mr-3 bg-green-500/90  hover:bg-green-600/80 focus:ring-4 focus:outline-none font-medium rounded-md text-sm px-5 h-8 ' />
