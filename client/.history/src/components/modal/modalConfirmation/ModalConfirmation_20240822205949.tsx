              ...
              <div className="relative p-4 text-center bg-white rounded-lg shadow  sm:p-5">
                ...
                <div className="flex justify-center items-center space-x-4">
                  <button
                    ...
                    type="button"
                    className="py-2 px-3 text-sm font-medium text-white  rounded-lg border border-gray-200 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-primary-300 focus:z-10 bg-red-400"
                  >
                    Cancelar
                  </button>
                  <button
