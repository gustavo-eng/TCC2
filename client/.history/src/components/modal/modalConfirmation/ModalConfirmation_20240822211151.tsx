          ...
          >
            <div className="relative p-4 w-full max-w-md h-full md:h-auto">
              <div className="relative p-4 text-center bg-white rounded-lg shadow  sm:p-5">
                <button
                  type="button"
                  className="text-red-400 absolute top-2.5 right-2.5 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center "
                  onClick={closeModal}
                >
                  <svg
                    aria-hidden="true"
                ...
                <div className="flex justify-center items-center space-x-4">
                  <button
                    ...
                    type="button"
                    className="py-2 px-3 text-sm font-medium text-white  rounded-lg border border-gray-200 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-primary-300 focus:z-10 bg-red-500"
                  >
                    Cancelar
                  </button>
                  <button
