                    ...
                    <div className="flex flex-row justify-end bg-white  p-1 rounded-b-lg  ">
                        {hasFooter && (
                            <>
                                ...
                                <Button onClick={onClickCancel} label={labelBtnCancel || 'Cancel'} type="button" className='mr-1 focus:ring-4 focus:outline-none font-medium rounded text-sm px-5 h-8  bg-red-500' />
                            </>
                        )}
                    </div>
                </div>
