                    ...
                    <div className="flex flex-row justify-end bg-white   rounded-b-lg  ">
                        {hasFooter && (
                            <div className='mr-2 mt-4'>
                                ...
                                <Button onClick={onClickCancel} label={labelBtnCancel || 'Cancel'} type="button" className=' focus:outline-none font-medium rounded-md text-sm px-5 h-8  bg-red-500/80 hover:bg-red-800' />
                            </div>
                        )}
                    </div>
                </div>
