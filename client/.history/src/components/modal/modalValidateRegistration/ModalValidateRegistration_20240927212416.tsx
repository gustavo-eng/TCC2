...
function ModalValidateRegistration({
    ...
    let currentSchema = action === 'accept' ? validateSchemaOptional : validateSchema;
    ...
    useEffect(() => {
        // Quando a ação mudar, redefinir o formulário para garantir que o novo schema seja aplicad
        reset();
    }, [action, reset]);
