    ...
    return (
        <div>
            <Modal
              ...
              labelBtnOk="Aprovarffffffffffffffffffffffffffffffffffff"
            >
             <div>
                ...
                <div className="bg-green-100 h-[35vh] rounded-md border-[1px] border-green-800 border-dashed flex justify-center">
                    <img src={comprovante} className='h-full '/>
                </div>
                <div className="">
                    <p className="mt-3 font-medium text-[17px]">Orientação</p>
                    <textarea className="w-full p-2  border-[1px] border-green-800 rounded-md"  rows={4}/>
                </div>
             </div>
            </Modal>
        </div>
