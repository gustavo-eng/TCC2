...
import { validateRegistration, validateSchema, validateSchemaOptional } from "./TypesValidate";
...
function ModalValidateRegistration({
    ...
    const {
        ...
        resolver: zodResolver(action?.includes('accept')?  validateSchemaOptional :  validateSchema)
