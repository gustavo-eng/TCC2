...
export default function Modal({
    ...
    return (
        ...
        >
            ...
            >
                {/* Modal content */}
                <div className="relative rounded shadow bg-gray-100">
                    {/* Modal header */}
                    <div className=" flex items-center justify-between  rounded  h-10">
                        <h3 className="text-[18px] font-semibold text-green-800 px-3 py-3 ">
                            {textHeader || 'Modal'}
                        </h3>
                        <button
                            type="button"
