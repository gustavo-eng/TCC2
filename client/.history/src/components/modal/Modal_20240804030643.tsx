            ...
            >
                ...
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="flex flex-row justify-end p-1  border-t  rounded-b border-gray-300">
                        <Button onClick={onClose} label='I accept' type="reset" className='mr-2 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center' />
                        <button
                            type="button"
