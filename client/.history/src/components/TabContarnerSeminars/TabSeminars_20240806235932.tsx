...
export default function TabSeminars() {
    ...
    return (
        <div className="">
            <TimePicker label="" value="07:00" className='bg-white ' helperText={'fasdfaf'} ><Tooltip slot="tooltip" text="Tooltip text" />
                <Icon slot="prefix" icon="vaadin:vaadin-h" /></TimePicker>
