...
const validateButton = (e: any) => {
  const [isModalViewRegistration, setModalViewRegistration] =
  ...
  const openModalViewRegistraion = () => {
    console.log('btn Open Modal ee' , e)
    setModalViewRegistration(true)
  };
  return (
    <div className="h-full w-full flex flex-col items-center justify-center">
      <ModalViewRegistration
        isOpen={isModalViewRegistration}
        onClose={closeModalViewRegistraion}
      ...
      <Button
        ...
        onClick={openModalViewRegistraion}
      />
    </div>
  );
};
