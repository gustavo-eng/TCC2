...
function TableListAthlet({
  ...
  return (
    <div className={`w-full h-[53vh] ${themeClass} flex flex-col`} >
        <div className="bg-purple-300 w-full h-[8vh] ">
            <Input
              className=" bg-green-500 w-full  flex flex-col"
              spanInputClassName="bg-green-900  flex flex-col justify-end items-end"
