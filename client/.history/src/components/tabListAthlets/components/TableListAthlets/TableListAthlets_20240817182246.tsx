  ...
  function EditRemoveButtonsTable() {
    return (
      <div className="h-full flex flex-row justify-center items-center">
          <Edit width={17}  className="text-green-900 mr-4" onClick={() => console.log('handleClick Here ')} />
          <Trash width={17} className="text-red-800" onClick={() => console.log('Dentro do proprio componente ')}/>
      </div>
    );
  }
