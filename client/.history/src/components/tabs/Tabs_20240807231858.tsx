                ...
                <TabList className="flex  flex-row justify-center">
                    {tabs.map((tab) => (
                        <Tab
                            ...
                            className={({ selected }) =>
                                twMerge(
                                    'min-w-[9rem] min-h-[2.4rem] font-bold mr-3 mb-1 hover:text-black hover:bg-gray-200 rounded-md  focus:outline-0 flex gap-2 justify-center items-center transition duration-100',
                                    selected
