                ...
                <Tab.List className="flex overflow-x-auto p-2">
                    {tabs.map((tab) => (
                        <Tab
                            ...
                            className={({ selected }) =>
                                classNames(
                                    'min-w-[9rem] py-2.5 font-bold leading-5 hover:text-weg-5 focus:outline-0 flex gap-2 justify-center items-center transition duration-500',
                                    selected
                                        ? 'text-weg-5 border-b-2 border-weg-5'
