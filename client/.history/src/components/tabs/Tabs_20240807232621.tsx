                ...
                <TabList className="flex  flex-row justify-center">
                    {tabs.map((tab) => (
                        <Tab
                            ...
                            className={({ selected }) =>
                                twMerge(
                                    'min-w-[6.2rem] min-h-[2.8rem] font-bold mr-3 mb-1 mt-9 lg:mt-0 hover:text-white hover:bg-gray-500 rounded-md  focus:outline-0 flex gap-2 justify-center items-center transition duration-100',
                                    selected
