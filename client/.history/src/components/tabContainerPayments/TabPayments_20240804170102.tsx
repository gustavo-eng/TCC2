        ...
        <>
            ...
            >
                <div className=" w-full h-full">
                    ...
                    <div className=" bg-green-400 flex flex-row w-[80%] justify-around mt-1 items-center">
                        <div className="bg-pink-400">q</div>
                        <div className="bg-pink-500 h-full flex  items-center">
                            <Select
                                id="countries"
                                name="countries"
                                options={options}
                                className="bg-red-800 items-start"
                                label="Data"
                                onChange={(e) => console.log(e.target.value)}
                            />
                        </div>
