import { FileArrowDown, TrashSimple } from "@phosphor-icons/react";
        ...
        <>
            ...
            >
                <div className=" w-full h-full p-1">
                    ...
                    <section className="bg-red-400 w-full flex flex-row justify-end">
                        <FileArrowDown size={25} color="#0c3285" />
                        <span className="flex grid-flow-col">
                            fileName
                            <TrashSimple size={22} />
                        </span>
                    </section>
