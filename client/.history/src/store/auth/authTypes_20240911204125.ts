...
const userSchema = z.object({
    ...
    rg: z.string().min(1).max(14), // RG com diferentes formatos (dependendo do estado)
    birth: z.string().nullable(), // Pode ser uma string ou null
    phone: z.string().nullable(), // Pode ser string ou null
    name: z.string(),
