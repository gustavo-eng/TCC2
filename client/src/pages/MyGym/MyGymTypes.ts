...
export const updateGymSchema = z.object({
    ...
    street: z.string({message: "Deve ser uma string"}).min(5, {message: "Mínimo 5 caracteres"}).optional(),
    city: z.string({message: "Deve ser uma string"}).min(4, {message:"Mínimo 4 caracteres" }).optional(),
