...
router.get('/students/:gymId', globalEntitiesPermission, (req, res) => {
...
router.get('/:cnpj_Academia', globalEntitiesPermission, (req, res) => {
    const { cnpj_Academia } = req.params;
...
router.delete('/:cnpj_Academia', permissionFRPj, (req, res) => {
    const { cnpj_Academia } = req.params;
