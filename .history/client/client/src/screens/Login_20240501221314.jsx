...
export default function Login() {
    ...
    return (
        ...
        <div className="flex min-h-full flex-col justify-center px-6 justify-content-center  lg:px-8">
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    <div>
                        <div className="flex items-center justify-between">
                            ...
                            <div className="text-sm">
                                <a href="/events" className="font-semibold text-green-900 hover:text-green-900">Esqueceu senha ?</a>
                            </div>
                        </div>
                        <div className="mt-2">
                ...
                <p className="mt-10 text-center text-sm text-gray-500">
                    ...
                    <a href="/events" className="font-semibold leading-6 text-blue-800"> Cadastrar </a>
                </p>
            </div>
        </div>
