...
exports.findAllPayments = async (req, res) => {
    ...
    try {
        ...
        athlets.then(el => {
            ...
            console.log('Athlets:', JSON.parse(JSON.stringify(el))); // Formata os dados em uma string legível
            athletsIds = payload.filter(el => el['idGym'] === idGym).map(athlet => athlet.idAthlete);
            console.log(`ff`)
