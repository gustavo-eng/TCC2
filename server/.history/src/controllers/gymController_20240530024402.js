...
exports.findPaymentsOfEvent = async (req, res) => {
    ...
    try {
        ...
        console.log("idEvent para o pagamento ---> " + idEvent)
        ...
        console.log('idAthlet')
        console.log(athletIds)
        /*
        payment.then(el => console.log('el payment ->' + JSON.stringify(el, null, 2))).catch(err => {
