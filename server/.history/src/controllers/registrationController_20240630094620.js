...
exports.findMyPayments = async (req, res) => {
    ...
    try {
        ...
        return res.status(200).json(success(registrations, "payload"))
...
exports.findAllPaymentsOfGym = async (req, res) => {
    try {
        ...
        return res.status(200).json(success(registrations, "payload", "Payments listed successfully"));
...
exports.aprovePayment = async (req, res) => {
    ...
    try {
        ...
        return res.status(200).json(success(registration, "payload", "Payment aproved successfully"));
...
exports.reprovePayment = async (req, res) => {
    ...
    try {
        ...
        return res.status(200).json(success(registration, "payload", "Payment reproved successfully"));
...
exports.delete = async (req, res) => {
    try {
        ...
        await registration.destroy().then(_ => {
            ...
            return res.status(statusCode.INTERNAL_SERVER_ERROR).json(message("Error server. Error -> " + err));
        })
