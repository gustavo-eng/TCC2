...
//import { hasDuplicateAthlet } from "../helpers/hasDuplicateRequest";
const { hasDuplicateAthlet } = require('../helpers/hasDuplicateRequest');
...
exports.create = async (req, res) => {
    ...
    try {
        ...
        if (hasDuplicateAthlet(name, email, cpf, rg)) {
            return res.status(statusCode.BAD_REQUEST).json(fail("Athlet already exists"));
        } else {
