...
exports.reprovePayment = async (req, res) => {
    ...
    try {
        ...
        registration.update({ aproved: false, description: description || "" }).save();
...
exports.update = async (req, res) => {
    ...
    try {
        // Toodos os campos precisam ter, menos idCategory.
        ...
        if (idCategory == null || !idCategory || idCategory == undefined || idCategory == "") {
            delete newRegistration.idCategory;
        };


        registration.update(newRegistration).save();
