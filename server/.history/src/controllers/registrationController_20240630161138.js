...
exports.create = async (req, res) => {
    ...
    try {
        ...
        console.log('hasDuplicateRegistration({ athletId: idAthlete, categoryId: idCategory, eventId: idEvent })')
        console.log(await hasDuplicateRegistration({ athletId: idAthlete, categoryId: idCategory, eventId: idEvent }))
        if (hasDuplicateRegistration({ athletId: idAthlete, categoryId: idCategory, eventId: idEvent })) {
...
exports.update = async (req, res) => {
    ...
    try {
        ...
        // Procurar a inscrição com o idPayment fornecido
        //const registration = await Registration.findOne({ where: { idPayment } });
        ...
        // Criar o novo objeto de registro
